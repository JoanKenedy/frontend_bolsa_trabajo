            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="custom-text-block">
                        ...
                        <p class="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil explicabo vel doloremque laudantium a! Enim, error aliquam nihil eaque quibusdam, incidunt consequatur earum dignissimos ullam sit consequuntur rerum fuga minus voluptatem, harum odio corporis fugit.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="custom-text-block custom-border-radius-start">
                        <h2 class="text-white mb-3">Multiservices te ayuda a conseguir un nuevo trabajo con mayor facilidad</h2>
