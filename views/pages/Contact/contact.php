        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-12 mb-lg-5 mb-3">
                    ...
                    <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59736.18267835182!2d-105.27177703206264!3d20.64876256200254!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8421458b3a4cf3bf%3A0xb04059a71f761b42!2sCl%C3%ADnica%20Dental%20Ju%C3%A1rez!5e0!3m2!1ses-419!2smx!4v1705685478623!5m2!1ses-419!2smx" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                    ...
                    <div class="contact-info-wrap">
                        ...
                        <div class="contact-info d-flex align-items-center">
                            ...
                            <p class="mb-0">
                                ...
                                <a href="mailto:soporte@multiservices-job.mx" class="site-footer-link">
                                    soporte@multiservices-job.mx
                                </a>
                            </p>
                        </div>
                    </div>
                    ...
                    <form class="custom-form contact-form" action="#" method="post" role="form">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <input type="text" name="full-name" id="full-name" class="form-control" placeholder="Jose Juan" required>
                            </div>

                            <div class="col-lg-6 col-md-6 col-12">
                                <label for="email">Email </label>

                                <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="jose12@gmail.com" required>
                            </div>

                            <div class="col-lg-12 col-12">
                                <label for="message">Mensaje</label>

                                <textarea name="message" rows="6" class="form-control" id="message" placeholder="¿Como podemos ayudarte?"></textarea>
                            </div>
