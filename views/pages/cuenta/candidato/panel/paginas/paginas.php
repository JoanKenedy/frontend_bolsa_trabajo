...
if (isset($urlParams[2])) {
    ...
    if ($urlParams[2] == 'search') {
        include "views/pages/cuenta/candidato/busqueda/busqueda.php";
    }
};
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-12 form-mobil" id="form-mobil">
                <form class="custom-form hero-form " action="<?php echo $path ?>cuenta&candidato&busqueda" method="post" role="form">
            ...
            <div class="col-lg-12 col-12">
                <form class="custom-form hero-form " action="<?php echo $path ?>cuenta&candidato&busqueda" method="post" role="form" id="form-compu">
            ...
            <div class="container">
                        ...
                        <div class="wraper-job">
                            <div class="wraper-footer-job ">
                                ...
                                <div class="container-btn-postular">
                                    <a href="<?php echo $path ?>cuenta&candidato&panel&vacante_detalles?id_vacante=<?php echo $row['id_vacante']   ?>" class="custom-btn btn">Ver más</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12 col-12 paginacion-2">
                    ...
                    <ul class="paginar">
                        ...
                        <?php else : ?>
                            <li><a href="<?php echo $path ?>cuenta&candidato&panel&paginas?page=<?php echo $_GET['page'] - 1 ?>">
                                    <span><i class="bi bi-arrow-left-circle-fill"></i></span>
                                </a></li>
                        <?php endif; ?>
                        <?php for ($i = 1; $i <= $pages; $i++) : ?>
                            <li>
                                <a href="<?php echo $path ?>cuenta&candidato&panel&paginas?page=<?php echo $i ?>"><?php echo $i ?></a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <?php else : ?>
                            <li>
                                <a href="<?php echo $path ?>cuenta&candidato&panel&paginas?page=<?php echo $_GET['page'] + 1 ?>">
                                    <span><i class="bi bi-arrow-right-circle-fill"></i></span>
                                </a>
                            </li>
                        <?php endif; ?>
        ...
        <section class="grid-curriculum-index">
            ...
            <div class="container container-grid-curriculum-index">
                ...
                <div class="grid-item-curriculum-index">
                    ...
                    <a href="<?php echo $path ?>cuenta&candidato&postulaciones" class="custom-btn btn">Ver
                        Postulaciones</a>
                </div>
            </div>
