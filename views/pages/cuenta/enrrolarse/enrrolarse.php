<div class="container">
    ...
    <div class="ps-my-account">
        <div class="container">
            <form class="custom-form hero-form form-login requires-validation" action="<?php echo $path ?>cuenta&registro" novalidate method="post" role="form">
                <h3 class=" text-center mb-3">
                    <a href="<?php echo $path ?>cuenta&enrrolarse" class="text-dorado"> Registro</a> &nbsp; <a href="<?php echo $path ?>cuenta&acceso" class="text-gray">Iniciar sesión</a>
                </h3>
