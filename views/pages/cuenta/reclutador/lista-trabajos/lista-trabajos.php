                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap align-items-center mt-4 mt-lg-0">
                                    ...
                                    <div>
                                        <a href="#" class="badge">Web design</a>

                                        <a href="#" class="badge">Marketing</a>

                                        <a href="#" class="badge">Customer support</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="job-thumb job-thumb-box">
                            <div class="job-image-box-wrap">
                                ...
                                <div class="job-image-box-wrap-info d-flex align-items-center">
                                    <p class="mb-0">
                                        <a href="#" class="badge badge-level">Internship</a>
                                    </p>

                                    <p class="mb-0">
                                        <a href="#" class="badge">Freelance</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="#" class="job-title-link"><?php echo $value->title_vacante ?></a>
                                </h4>
                                ...
                                <div class="d-flex align-items-center border-top pt-3">
                                    ...
                                    <a href="#" class="custom-btn btn ms-auto">Postularme</a>
                                </div>
                            </div>
                        </div>
                    </div>
