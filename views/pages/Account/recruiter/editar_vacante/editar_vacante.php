                     ...
                     <div class="row ">
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="titleEditVacante" class="form-control input-group"
                                     placeholder="ej:Diseñador Jr" required
                                     value="<?php echo $verificarEditarVacante->results[0]->title_vacante ?>">
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="sueldoEditVacante" class="form-control input-group"
                                     placeholder="10,000 a 12,000" required
                                     value="<?php echo $verificarEditarVacante->results[0]->rango_sueldo ?>">
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="educacionEditRequerida" class="form-control input-group"
                                     placeholder="Preparatoria Concluida " required
                                     value="<?php echo $verificarEditarVacante->results[0]->educacion_requerida ?>">
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="tipoEditContratacion" class="form-control input-group"
                                     placeholder="Temporal " required
                                     value="<?php echo $verificarEditarVacante->results[0]->tipo_contratacion ?>">
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="horarioEditVacante" class="form-control input-group"
                                     placeholder="9:00am a 18:00pm" required
                                     value="<?php echo $verificarEditarVacante->results[0]->horario ?>">
                         ...
                         <div class="col-lg-6 col-md-6 col-12">
                             <div class="input-control">
                                 ...
                                 <input type="text" name="lugarEditTrabajo" class="form-control input-group"
                                     placeholder="Cdmx Colonia Centro #12" required
                                     value="<?php echo $verificarEditarVacante->results[0]->lugar_de_trabajo ?>">
