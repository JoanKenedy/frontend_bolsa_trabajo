                ...
                <div class="row ">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="giroEmpresa" class="form-control input-group"
                                placeholder="ej:Farmaceutico" required>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="razonEmpresa" class="form-control input-group"
                                placeholder="Razon social de tu empresa" required>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="email" name="rfcEmpresa" class="form-control input-group" placeholder="Email "
                                required>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="numTrabajadores" class="form-control input-group"
                                placeholder="Numero de colaboradores en tu empresa" required>
