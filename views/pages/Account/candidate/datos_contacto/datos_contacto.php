                ...
                <div class="row ">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="regPuesto" class="form-control input-group" placeholder="ej: Ejecutivo de ventas" required>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="regSueldo" class="form-control input-group" placeholder="Sueldo aproximado" required>
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="input-control">
                            ...
                            <input type="text" name="regGenero" class="form-control input-group" placeholder="Masculino" required>
