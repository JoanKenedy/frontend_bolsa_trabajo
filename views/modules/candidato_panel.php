                ...
                <div class="col-lg-12 col-12 paginacion-2">
                    ...
                    <ul class="paginar">
                        ...
                        <?php for ($i = 1; $i <= $pages; $i++) : ?>
                            <li class="li-item">
                                <a class="a-item" href="<?php echo $path ?>cuenta&candidato&panel&paginas?page=<?php echo $i ?>"><?php echo $i ?></a>
                            </li>
                        <?php endfor; ?>


                        <li class="li-item">
                            <a class="a-item" href="<?php echo $path ?>cuenta&candidato&panel&paginas?page=<?php echo 2 ?>">
