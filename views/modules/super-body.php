                    ...
                    <div class="wraper-job">
                        <div class="postulaciones-vacantes ">
                            ...
                            <h4 class="job-titulo  text-center mb-lg-0">
                                <a href="job-details.html" class="job-title-link"><?php echo $value->nombre ?> <?php echo $value->apellidos ?></a>
                            ...
                            <div class="container-btn-postular">
                                <a href="<?php echo $path ?>account&recruiter&postulaciones&details_cv?id_cv=<?php echo $value->id_usuario_postulacion  ?>" class="custom-btn btn">Ver curriculum</a>
                            </div>
                        </div>
                    </div>
