                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="input-control">
                                                ...
                                                <p class="text-label2">Educación requerida:</p>
                                                <input type="text" name="educacionRequerida"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="input-control">
                                                ...
                                                <p class="text-label2">Tipo de contratación:</p>
                                                <input type="text" name="tipoContratacion"
                                                    class="form-control input-group" placeholder="Temporal " required>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-12">
                                            <div class="input-control">
                                                ...
                                                <p class="text-label2">Horario:</p>
                                                <input type="text" name="horarioVacante"
                                                    class="form-control input-group" placeholder="9:00am a 18:00pm"
                                                    required>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-12">
                                            <div class="input-control">
                                                ...
                                                <input type="file" name="fotoVacante" class="form-control input-group"
                                                    required>
                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="container-vacante ">
                            <div class="item-container-vacante">
                                ...
                                <img src="images/descargas/<?php echo $value->foto_vacante ?>" alt=""
                                    class="img-redonda">
                                <?php else :  ?>
